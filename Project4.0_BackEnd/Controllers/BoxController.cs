...
namespace Project4._0_BackEnd.Controllers
{
    ...
    public class BoxController : ControllerBase
    {
        ...
        {
            var box = await _context.Boxes.Where(b => b.BoxID == id).Include(b => b.SensorBoxes).ThenInclude(s => s.Sensor).ThenInclude(s => s.SensorType).Include(s => s.SensorBoxes).ThenInclude(s => s.Measurements).FirstAsync();
